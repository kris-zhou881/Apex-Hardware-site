...
const en={products:"Products",engineering:"Engineering",quote:"Get a quote",eyebrow:"Hydraulic floor springs",hero:"Invisible control.<br>Remarkable movement.",sub:"Precision door control for glass, timber and metal doors — engineered for quiet, confident motion.",explore:"Explore the range ↓",compare:"Compare models ↗",precision:"Power, made precise.",precisionSub:"Two-stage speed control. Stable at every opening. Built for high-traffic architecture.",range:"Four strengths. One standard.",rangeSub:"Choose by door weight and width."};
const tr={
 zh:{products:"产品",engineering:"技术",quote:"获取报价",eyebrow:"液压地弹簧",hero:"隐于地面。<br>掌控每一次开合。",sub:"适用于玻璃门、木门和金属门的精密门控系统，安静、稳定、可靠。",explore:"查看全系列 ↓",compare:"对比型号 ↗",precision:"力量，精准掌控。",precisionSub:"两段速度调节，为高频使用的建筑空间而生。",range:"四种承重，同一标准。",rangeSub:"按门重和门宽选择适合的型号。"},
